<h2><a href="https://leetcode.com/problems/falling-squares/?envType=problem-list-v2&envId=segment-tree">699. Falling Squares</a></h2><h3>Hard</h3><hr><p>There are several squares being dropped onto the X-axis of a 2D plane.</p>
