<h2><a href="https://leetcode.com/problems/count-prime-gap-balanced-subarrays">3589. Count Prime-Gap Balanced Subarrays</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
