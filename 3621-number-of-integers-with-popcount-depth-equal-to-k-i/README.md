<h2><a href="https://leetcode.com/problems/number-of-integers-with-popcount-depth-equal-to-k-i/">3621. Number of Integers With Popcount-Depth Equal to K I</a></h2><h3>Hard</h3><hr><p>You are given two integers <code>n</code> and <code>k</code>.</p>
